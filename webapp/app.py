...
df_selected_players = pd.read_pickle("static/dataframes/df_selected_players.pkl")

# Load data (deserialize)
with open('static/dataframes/label_dictionnary.pkl', 'rb') as handle:
...
def main():
    return(flask.render_template('main.html',data=df_html))
